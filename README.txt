Munhoz Running — Linktree
=========================
Como usar:
1) Suba tudo isso para um repositório público no GitHub (ex.: munhoz-link).
...
- Resolução: até 1080p, 24–30fps.
- Codec: H.264 (MP4). Ferramentas: HandBrake, CapCut, ffmpeg.

Personalizações rápidas:
- Troque a foto de perfil (assets/avatar.jpg).
- O cupom já está configurado como PEDRO15.
